# -*- coding: utf-8 -*-
"""
Created on Sat Jun 26 19:17:05 2021
...
#psi = (np.pi*(a**2))/(b**2)                # razão de área perfurada
#denssup = (rho0*(b**2)*lc)/(np.pi*(a**2))  # [kg/m²] densidade superficial do gás contido na perfuração
psi = 0.1
denssup = rho0*(1/psi)*(lc+(((8*viscos/omega)*(1+(l/2*a)))**0.5)) 
