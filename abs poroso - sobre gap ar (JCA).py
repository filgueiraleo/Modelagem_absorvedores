# -*- coding: utf-8 -*-
"""
Created on Sat Jun 26 17:39:21 2021

@author: leofilgueira
"""

# Modelagem de absorvedor poroso sobre colchão de ar (JCA)
...
Zs = ((-1j * Zc * Zsar / np.tan(kc*d)) + Zc**2) / (Zsar - (1j * (Zc / np.tan(kc*d))))  # Impedância de Superfície

                   
reflex = (Zs - (rho0*c0)) / (Zs + (rho0*c0))   # Coeficiente de reflexão
alpha = 1 - abs(reflex) ** 2                   # Coeficiente de absorção alpha
